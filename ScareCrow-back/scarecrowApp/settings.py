...
SECRET_KEY = 'django-insecure-b(g=r9spf7-ag=fh2iz%=$jc*#9xu%(!)82_%s*7g_n*_w704q'
...
ROOT_URLCONF = 'scarecrowApp.urls'
...
INSTALLED_APPS += ['disease_detector']
...
SESSION_COOKIE_SECURE = False   # Disable HTTPS for testing
